...
import { getCategoryBySlug, type CategoryDetail } from "@/app/api/category/getCategoryBySlug";
...
interface CategoryPageClientProps {
  ...
  initialCourses?: Awaited<ReturnType<typeof searchCourses>>;
}

const COURSES_PER_PAGE = 9;

export function CategoryPageClient({ slug, initialCategory, initialCourses }: CategoryPageClientProps) {
  ...
  if (categoryLoading && !initialCategory) {
