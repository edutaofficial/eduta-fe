...
export function StudentSettings() {
  ...
  const getInitials = () => {
    const firstName = accountFormik.values.firstName || user?.name || "S";
  ...
  return (
    <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              <form onSubmit={accountFormik.handleSubmit} className="space-y-6">
                ...
                {/* Date of Birth */}
                <div className="space-y-2">
                  <Label htmlFor="dateOfBirth" className="text-default-700">
                    Date of Birth (Optional)
                  </Label>
                  <div className="relative">
                    <CalendarIcon className="absolute left-3 top-1/2 -translate-y-1/2 size-5 text-default-400" />
                    <Input
                      id="dateOfBirth"
                      name="dateOfBirth"
                      type="date"
                      value={accountFormik.values.dateOfBirth}
                      onChange={accountFormik.handleChange}
                      onBlur={accountFormik.handleBlur}
                      className={`pl-10 ${
                        accountFormik.touched.dateOfBirth &&
                        accountFormik.errors.dateOfBirth
                          ? "border-error-500"
                          : ""
                      }`}
                      disabled={loading.updateProfile}
      ...
      {/* Password Reset Multi-Step Dialog - Same as Instructor */}
      <Dialog
