export const CONSTANTS = {
  ...
  HERO_SLIDES: [
    {
      ...
      subtitle: "Master strategy, decision-making, and leadership skills trusted by global organizations.",
      highlights: [
    ...
    },
    {
      ...
      subtitle: "Boost productivity, confidence, and communication to achieve success in every area of life.",
      highlights: [
    ...
    },
    {
      ...
      subtitle: "Master resume writing, job interview skills, and career development strategies to stand out.",
      highlights: [
      ...
      studentStats: {
        students: [
          ...
          { id: 2, name: "Ayesha", image: "https://i.pravatar.cc/150?img=16" },
          { id: 3, name: "Daniel", image: "https://i.pravatar.cc/150?img=14" },
        ],
        learnerCount: "8,500+",
      },
    },
  ...
  CONTACT_INFO: {
    ...
    phone: "+1 (289) 698-5448",
    address: {
      company: "Eduta, Inc.",
      street: "169 Fifth Avenue",
      city: "Kitchener",
      province: "Ontario",
      postalCode: "N2C 1P6",
      country: "Canada",
